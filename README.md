...
1. **[01-aws-iam-governance](./01-aws-iam-governance/)** — Identity and Access Management (4 Labs)
2. **[02-aws-ec2-security-groups](./02-aws-ec2-security-groups/)** — Compute & Network Security (4 Labs)
3. **[03-aws-elb-asg-elasticity](./03-aws-elb-asg-elasticity/)** — High Availability & Elasticity (2 Labs)
4. **[04-aws-s3-storage-lifecycle](./04-aws-s3-storage-lifecycle/)** — Object Storage & Data Protection (3 Labs)
5. **[05-aws-rds-database-security](./05-aws-rds-database-security/)** — Managed Databases (2 Labs)
6. **[06-aws-vpc-network-isolation](./06-aws-vpc-network-isolation/)** — Virtual Private Cloud & Networking (3 Labs)
7. **[07-aws-cloudwatch-observability](./07-aws-cloudwatch-observability/)** — Monitoring, Logging & Alarms (3 Labs)
